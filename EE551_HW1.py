...
def lists():
    ...
    ## Need Coordinates {0,2} {1,1} {2,0}. range(3) gives [0,1,2]. Can complement using size of matrix. [2- 0,2 - 1,2 - 2] -> [2,1,0]
    d = [A[x][len(A) - 1 - x] for x in range(len(A)) if A[x][len(A) - 1 - x] % 2 == 0]
